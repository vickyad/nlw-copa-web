...
import appPreviewImg from '../assets/cellphone-banner.png'
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28">
      <main>
        ...
        <form onSubmit={handleSubmit} className="mt-10 flex gap-2" action="">
          <input
          ...
          />
          <button
            className="bg-yellow-500 hover:bg-yellow-700 px-6 py-4 rounded font-bold text-gray-900 text-sm"
            type="submit"
          >
            CRIAR SEU BOLÃO
          </button>
